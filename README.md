# Social Media and Web Analytics Lab: Difference-in-Difference (DiD)
...
Once you have cloned the files, open the cloned repository in RStudio as an RStudio project and work through the questions in `lab_did_answer.Rmd`.
